...
export default async function ServicesPage({ params }: ServicesPageProps) {
  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-16 px-6 py-12 md:gap-24 md:py-20">
      <section className="page-hero-panel grid gap-10 p-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end md:p-10">
        ...
        <Reveal
          className="elevated-card rounded-[1.75rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.84),rgba(238,228,217,0.92))] p-8"
          delay={0.08}
        >
