...
const content = {
  ...
  closingBody:
    "Si te acomoda mas escribir por WhatsApp, tambien puedes hacerlo directamente. Aqui encuentras ademas el correo, la ubicacion de referencia y el horario de atencion."
} as const;

export default async function ContactPage() {
  const [contactData, siteSettings] = await Promise.all([getContactPageData(), getSiteSettings()]);
  const page = mapContactContent(content, contactData);
